 ...
 * <p>
 * VectorDrawableCompat2 are defined in the same XML format as {@link VectorDrawable}.
 * </p>
 * You can always create a VectorDrawableCompat2 object and use it as a Drawable by the Java API.
 * In order to refer to VectorDrawableCompat2 inside a XML file,  you can use app:srcCompat attribute
 * in AppCompat library's ImageButton or ImageView.
 */
@TargetApi(Build.VERSION_CODES.LOLLIPOP)
public class VectorDrawableCompat2 extends VectorDrawableCommon {
    ...
    VectorDrawableCompat2() {
        mVectorState = new VectorDrawableCompatState();
    }

    VectorDrawableCompat2(@NonNull VectorDrawableCompatState state) {
        mVectorState = state;
...
//    /**
//     * Create a VectorDrawableCompat2 object.
//     *
//     * @param res   the resources.
//     * @param resId the resource ID for VectorDrawableCompat2 object.
//     * @param theme the theme of this vector drawable, it can be null.
//     * @return a new VectorDrawableCompat2 or null if parsing error is found.
//     */
//    @Nullable
//    public static VectorDrawableCompat2 create(@NonNull Resources res, @DrawableRes int resId,
//                                               @Nullable Theme theme) {
//        if (Build.VERSION.SDK_INT >= 23) {
//            final VectorDrawableCompat2 drawable = new VectorDrawableCompat2();
...
//    }
    ...
    /**
     * Create a VectorDrawableCompat2 from inside an XML document using an optional
     * {@link }. Called on a parser positioned at a tag in an XML
     * document, tries to create a Drawable from that tag. Returns {@code null}
     * if the tag is not a valid drawable.
     */
    public static VectorDrawableCompat2 createFromXmlInner(Resources r, XmlPullParser parser,
...
//        final TypedArray2 a = obtainAttributes(res, theme, attrs,
...
//
//        final int mode = TypedArrayUtils2.getNamedInt(a, parser, "tintMode",
...
//        }
//
//        state.mAutoMirrored = TypedArrayUtils2.getNamedBoolean(a, parser, "autoMirrored",
//                AndroidResources.styleable_VectorDrawable_autoMirrored, state.mAutoMirrored);
//
//        pathRenderer.mViewportWidth = TypedArrayUtils2.getNamedFloat(a, parser, "viewportWidth",
//                AndroidResources.styleable_VectorDrawable_viewportWidth,
//                pathRenderer.mViewportWidth);
//
//        pathRenderer.mViewportHeight = TypedArrayUtils2.getNamedFloat(a, parser, "viewportHeight",
...
//        final float alphaInFloat = TypedArrayUtils2.getNamedFloat(a, parser, "alpha",
...
//    }
        ...
        while (eventType != XmlPullParser.END_DOCUMENT) {
            if (eventType == XmlPullParser.START_TAG) {
                ...
                if (SHAPE_PATH.equals(tagName)) {
                    ...
                    newChildGroup.inflate(res, attrs, parser);
     ...
     * Instead of creating a VectorDrawable, create a VectorDrawableCompat2 instance which contains
    ...
    private static class VectorDrawableDelegateState extends ConstantState {
        ...
        public Drawable newDrawable() {
            VectorDrawableCompat2 drawableCompat = new VectorDrawableCompat2();
    ...
    private static class VectorDrawableCompatState extends ConstantState {
        ...
        @Override
        public Drawable newDrawable() {
            return new VectorDrawableCompat2(this);
        }
    ...
    private static class VGroup {
        ...
        public void inflate(Resources res, AttributeSet attrs, XmlPullParser parser) {
            final TypedArray a = obtainAttributes(res, null, attrs,
        ...
        private void updateStateFromTypedArray(TypedArray a, XmlPullParser parser) {
            ...
            mRotate = TypedArrayUtils2.getNamedFloat(parser, "rotation",
       ...
       //     mPivotY = a.getFloat(AndroidResources.styleable_VectorDrawableGroup_pivotY, mPivotY);
            ...
            // This is added in API 11
            mScaleX = TypedArrayUtils2.getNamedFloat( parser, "scaleX",
                    AndroidResources.styleable_VectorDrawableGroup_scaleX, mScaleX);

            // This is added in API 11
            mScaleY = TypedArrayUtils2.getNamedFloat( parser, "scaleY",
                    AndroidResources.styleable_VectorDrawableGroup_scaleY, mScaleY);

            mTranslateX = TypedArrayUtils2.getNamedFloat( parser, "translateX",
                    AndroidResources.styleable_VectorDrawableGroup_translateX, mTranslateX);
            mTranslateY = TypedArrayUtils2.getNamedFloat( parser, "translateY",
    ...
    private static class VClipPath extends VPath {
        ...
        public void inflate(Resources r, AttributeSet attrs,  XmlPullParser parser) {
            // TODO TINT THEME Not supported yet
            final boolean hasPathData = TypedArrayUtils2.hasAttribute(parser, "pathData");
            if (!hasPathData) {
                return;
            }
            final TypedArray a = obtainAttributes(r, null, attrs,
    ...
    private static class VFullPath extends VPath {
        ...
        public void inflate(Resources r, AttributeSet attrs, XmlPullParser parser) {
//            final TypedArray2 a = obtainAttributes(r, null, attrs,
//                    AndroidResources.styleable_VectorDrawablePath);
   ...
   //       a.recycle();
        ...
        private void updateStateFromTypedArray( XmlPullParser parser) {
            ...
            // B/c if the attribute existed in the compiled XML, then calling TypedArray2 will be
