 ...
 */
public class VectorDrawableCompat3 extends VectorDrawableCommon {
	...
	VectorDrawableCompat3() {
		mVectorState = new VectorDrawableCompatState();
	}

	VectorDrawableCompat3(@NonNull VectorDrawableCompatState state) {
		mVectorState = state;
	 ...
	 */
	@Nullable
	public static VectorDrawableCompat3 create(@NonNull Resources res, @DrawableRes int resId,
											  @Nullable Theme theme) {
		if (Build.VERSION.SDK_INT >= 24) {
			final VectorDrawableCompat3 drawable = new VectorDrawableCompat3();
	 ...
	 */
	public static VectorDrawableCompat3 createFromXmlInner(Resources r, XmlPullParser parser,
	...
	private static class VectorDrawableCompatState extends ConstantState {
		...
		@Override
		public Drawable newDrawable() {
			return new VectorDrawableCompat3(this);
		}
