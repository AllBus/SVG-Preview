 ...
 */
@ViewPager.DecorView
public class TabLayoutWithListener extends HorizontalScrollView {

    public interface IScrollTab{
        void onScrollTabs(float xy);
    }


    private IScrollTab scrollListener;

    public IScrollTab getScrollListener() {
        return scrollListener;
    }

    public void setScrollListener(IScrollTab scrollListener) {
    ...
    /**
     * Gravity used to fill the {@link TabLayoutWithListener} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link TabLayoutWithListener}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    private int mTabMaxWidth = Integer.MAX_VALUE/3;
    ...
    public TabLayoutWithListener(Context context) {
        this(context, null);
    }

    public TabLayoutWithListener(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TabLayoutWithListener(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    /**
     * Add a {@link TabLayoutWithListener.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     *
    ...
    /**
     * Remove the given {@link TabLayoutWithListener.OnTabSelectedListener} that was previously added via
    ...
    /**
     * Remove all previously added {@link TabLayoutWithListener.OnTabSelectedListener}s.
     */
    ...
    /**
     * Returns the current mode used by this {@link TabLayoutWithListener}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    /**
     * The one-stop shop for setting up this {@link TabLayoutWithListener} with a {@link ViewPager}.
     *
    ...
    private void applyModeAndGravity() {
        ...
        if (mMode == MODE_SCROLLABLE) {
            ...
            paddingStart = Math.max(0, mContentInsetStart);
        }
        ViewCompat.setPaddingRelative(mTabStrip, paddingStart, 0, paddingStart, 0);
    ...
    public int rightScrollPosition(){
        if (mTabStrip.getChildCount()>0){
            return mTabStrip.getChildAt(mTabStrip.getChildCount()-1).getRight();
        }
        return getWidth();
    }
    /**
    ...
    public static final class Tab {
        ...
        private TabLayoutWithListener mParent;
     ...
     * necessary calls back to the provided {@link TabLayoutWithListener} so that the tab position is
     * kept in sync.
     *
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<TabLayoutWithListener> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(TabLayoutWithListener tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final TabLayoutWithListener tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link TabLayoutWithListener.OnTabSelectedListener} class which contains the necessary calls back
     * to the provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements TabLayoutWithListener.OnTabSelectedListener {
        ...
        @Override
        public void onTabSelected(TabLayoutWithListener.Tab tab) {
            mViewPager.setCurrentItem(tab.getPosition());
        }

        @Override
        public void onTabUnselected(TabLayoutWithListener.Tab tab) {
            // No-op
        }

        @Override
        public void onTabReselected(TabLayoutWithListener.Tab tab) {
            // No-op
        }
    }
